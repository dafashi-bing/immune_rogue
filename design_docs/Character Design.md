...
- Canvas Size: 48×48 px for heroes; 32×32 px for standard enemies (64×64 for larger “boss” foes).  
- Palette: 16-color max per sprite; shared “cell biology” palette (beige, aqua, pink, orange, mint, red + neutrals).  
- Animation Frames:  
...
- Style: clean silhouettes, rounded edges, single-pixel outline in darker tone for readability.
...
1. **Macrophage** (Circle → 48×48)  
   ...
   - Idle wiggle: slow 1 px radial “pulse.”  
...
3. **Helper T-cell** (Square → 48×48)  
   ...
   - Attack pose: membrane folds thrust outward.  
...
Once this section is approved, we’ll proceed to “2. Ability Effects.”
